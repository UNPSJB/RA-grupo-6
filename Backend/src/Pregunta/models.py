...
class Pregunta(ModeloBase):
    ...
    pregunta_fuente_dos_id: Mapped[Optional[int]] = mapped_column(ForeignKey("preguntas.id"), nullable=True)
    ...
    preguntas_que_la_usan_dos: Mapped[list["Pregunta"]] = relationship("Pregunta", back_populates="pregunta_fuente_dos", foreign_keys=[pregunta_fuente_dos_id])
    ...
    pregunta_fuente: Mapped[Optional["Pregunta"]] = relationship("Pregunta", remote_side=[id], foreign_keys=[pregunta_fuente_id], back_populates="preguntas_que_la_usan", uselist=False)
    pregunta_fuente_dos: Mapped[Optional["Pregunta"]] = relationship("Pregunta", remote_side=[id], foreign_keys=[pregunta_fuente_dos_id],back_populates="preguntas_que_la_usan_dos" ,uselist=False)

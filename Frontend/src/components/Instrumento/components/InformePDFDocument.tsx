      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Fecha de finalización: {new Date(informe.fecha_completado).toLocaleDateString()}
        ...
        {/* --- SECCIÓN: Respuestas Abiertas por Aspecto --- */}
        {informe.respuestas_abiertas_agrupadas && informe.respuestas_abiertas_agrupadas.length > 0 && (

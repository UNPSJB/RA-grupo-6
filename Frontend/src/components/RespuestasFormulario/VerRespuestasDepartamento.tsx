...
export default function VerRespuestasDepartamento() {
        ...
        return (
            <ShadowedCard className="text-center">
                <CCardBody className="p-5">
                    ...
                    <p className="text-medium-emphasis">Cargando informes sintéticos respondidos...</p>
                </CCardBody>
            </ShadowedCard>
        );
    }
    ...
    return (
        <ShadowedCard>
            <CCardHeader>
                <div className="m-2">
                    <h4>Informes Sintéticos Respondidos</h4>
            ...
            <CCardBody>
                ...
                {instrumentos.length > 0 ? (
                    ...
                    <div className="text-center py-5">
                        ...
                        <h5 className="text-medium-emphasis mb-3">No hay informes sintéticos respondidos</h5>
